...
const Navbar = () => {
  return (
    <header className="z-50 absolute top-2 sm:top-4 left-0 w-full px-2 sm:px-4">
      <nav className="border bg-sidebar/15 backdrop-blur-sm shadow flex items-center justify-between gap-4 p-2 rounded-2xl">
        <div className="flex items-center gap-2">
          ...
          >
            <h1 className="text-lg font-medium hidden sm:block">Resoome</h1>
          </Link>
        </div>
        <div className="flex items-center gap-2">
          <TemplateButton />
